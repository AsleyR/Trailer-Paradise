  ...
  return (
    <div className='max-w-full h-screen bg-dark2'>
      <div className='grid grid-cols-1 justify-items-center px-0 md:px-10 lg:px-10 pt-56'>
          ...
          <h2 className='px-10 lg:px-80 my-5 text-lg text-white sm:text-lg md:text-2xl font-thin text-center'>Sorry, we can't find that page. Perhaps you may want to return to the homepage.</h2>
